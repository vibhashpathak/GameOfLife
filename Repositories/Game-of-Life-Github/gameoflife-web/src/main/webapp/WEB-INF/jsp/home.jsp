...
<html>
<head>
    <title>The Game Of Life for Sal!</title>
    ...
    <style type="text/css">
        ...
        .intro {
            ...
            border: 4pt rgb(150, 150, 150) solid;
            padding: 8px;
            margin: 4px;
            text-align: justify;
            color: rgb(25, 25, 25)
...
<body>
<h2>Welcome to Conway's Game Of Life, ANSI!</h2>
<h3>Enjoy!</h3>
<div class="intro">
...
<!--<div class="action-button">-->
    <a href="${newGamePage}">New Game
        <img src="icon_universe.png" alt="New Game" style="width:42px;height:42px;border:0;">
    </a>
<!--</div>-->
